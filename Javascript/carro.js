 ...
 * @param {int} anio - A#o de fabricacion del vehiculo
 * @param {poolean} disponible - Estado de disponibilidad del vehiculo (true: disponible)
 * @method alquilar - Cambia el estado de disponibilidad  a false si el vehiculo esta 
 * @method devolver - Cambia el estado de disponibilidad a true
 * @method informacion - Imprime toda la informacion del vehiculo (marca, modelo, a#o, ) 
 */
class Vehiculo {
 ...
 * @method agregarVehiculo @param vehiculo {object} - A#ade un vehiculo a la flota
 * @method mostrarVehiculosDisponibles - Imprime la informacion de todos los vehiculos
 * @method mostrarVehiculos - Imprime la informacion de todos los vehiculos en la flota
 */
class EmpresaAlquiler {
  constructor(flota = []) {
    this.flota = flota;
